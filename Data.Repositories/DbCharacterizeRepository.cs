...
namespace Data.Repositories
{
    public class DbCharacterizeRepository<T> : IDbCharacterizeRepository<T> where T : class, ICharacteristic<T>
    {
        ...
        public DbCharacterizeRepository(T entity, int idCharactere, CyberContext context)
        {
            _context = context;
        ...
        public TEntity GetEntity<TEntity>(int id) where TEntity : class, ICharacteristic<TEntity>
        {
            try
            {
